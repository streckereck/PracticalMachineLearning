...
download.file("https://d396qusza40orc.cloudfront.net/predmachlearn/pml-training.csv",
              "C:/Users/cferster/Dropbox/practicalMachineLearning/pml.csv")
pml <- read.csv("C:/Users/cferster/Dropbox/practicalMachineLearning/pml.csv")
...
download.file("https://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv",
              "C:/Users/cferster/Dropbox/practicalMachineLearning/pml-testcases.csv")
pml_testcases <- read.csv("C:/Users/cferster/Dropbox/practicalMachineLearning/pml-testcases.csv")
...
C1 <- confusionMatrix(pml_testing$classe, predict(rf, pml_testing))
print(C1)
